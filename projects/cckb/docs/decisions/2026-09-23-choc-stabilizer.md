...
| 6 | プレートの下に出る量 | 未確認（二次情報のみ 2.5〜3.5mm） | 未確認。基板の逃げ穴は組み立てモデルで決める（計画3のpcb_extra）→ **2026-09-24 に O2 で決着**（下端は最も低くて床の上 1.3・基板の逃げ穴は輪郭＋0.5〔`spec.STAB_RELIEF_MARGIN`〕。open-gaps O2・decisions/2026-09-24-interface.md §2-6。「計画 3」という文書は書かれず、境界の決定で決めた） |
...
- プレートの開口が決まったことで、基板側の逃げ穴（`pcb_extra.py`）の設計が可能になる
  （こちらは計画 3 の範囲。本タスクでは未着手）→ **2026-09-24 に O2 で決着**（下端は最も低くて床の上 1.3・基板の逃げ穴は輪郭＋0.5〔`spec.STAB_RELIEF_MARGIN`〕。open-gaps O2・decisions/2026-09-24-interface.md §2-6。「計画 3」という文書は書かれず、境界の決定で決めた）。
...
| 基板の逃げ穴の大きさ・位置 | 組み立てモデル（3D）で決める。計画 3 の pcb_extra の範囲→ **2026-09-24 に O2 で決着**（下端は最も低くて床の上 1.3・基板の逃げ穴は輪郭＋0.5〔`spec.STAB_RELIEF_MARGIN`〕。open-gaps O2・decisions/2026-09-24-interface.md §2-6。「計画 3」という文書は書かれず、境界の決定で決めた） |
